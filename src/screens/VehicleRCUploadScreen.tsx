/**
 * Vehicle RC Upload Screen Component
 * Dedicated screen for Vehicle Registration Certificate upload
 * 
 * @component
 * @example
 * <VehicleRCUploadScreen />
 */
...
export default function VehicleRCUploadScreen() {
  ...
  React.useEffect(() => {
    (async () => {
      ...
      await setStoredOnboardingStep('/vehicle-rc-upload');
    })();
  }, []);
          ...
          <View style={styles.content}>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.sectionDescription}>
                Upload a clear photo of your Vehicle Registration Certificate (RC)
              </Text>
              ...
              >
                <Text style={styles.scanButtonText}>
                  {documentUri ? 'Change Document' : 'Upload Vehicle RC'}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
