/**
 * Vehicle Cycle Icon Component
 * Cycle icon for vehicle selection
 * Downloaded from Figma node-id: 13454:450
 */
...
interface VehicleCycleIconProps {
  size?: number;
  color?: string;
  style?: ViewStyle;
}

export default function VehicleCycleIcon({
  size = 28,
  color = '#99A1AF',
  style,
}: VehicleCycleIconProps) {
  return (
    <Svg
      width={size}
      height={size}
