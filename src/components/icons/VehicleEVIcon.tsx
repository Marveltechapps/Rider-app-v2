/**
 * Vehicle EV Icon Component
 * Electric vehicle icon for vehicle selection
 * Downloaded from Figma node-id: 13454:445
 */
...
interface VehicleEVIconProps {
  size?: number;
  color?: string;
  style?: ViewStyle;
}

export default function VehicleEVIcon({
  size = 28,
  color = '#99A1AF',
  style,
}: VehicleEVIconProps) {
